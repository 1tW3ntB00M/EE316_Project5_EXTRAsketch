...
## Pmod Header JA
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports Red[0]]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports Red[1]]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { Red[2] }]; #IO_L7P_T1_34 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { Red[3] }]; #IO_L7N_T1_34 Sch=ja_n[2]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { Blue[0] }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { Blue[1] }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { Blue[2] }]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { Blue[3] }]; #IO_L22N_T3_34 Sch=ja_n[4]

## Pmod Header JB
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports Green[0]]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports Green[1]]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { Green[2] }]; #IO_L1P_T0_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { Green[3] }]; #IO_L1N_T0_34 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { HS }]; #IO_L18P_T2_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { VS }]; #IO_L18N_T2_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { NC[0] }]; #IO_L4P_T0_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { NC[1] }]; #IO_L4N_T0_34 Sch=jb_n[4]
...
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports Pmod_LEDS[0]]; #[0]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports Pmod_LEDS[1]]; #[1]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { Pmod_LEDS[2] }]; #IO_L5P_T0_34 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { Pmod_LEDS[3] }]; #IO_L5N_T0_34 Sch=ck_io[3]
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { AIN3 }]; #IO_L21P_T3_DQS_34 Sch=ck_io[4]
#set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports oADCSDA]
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports oADCSCL]
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { ck_io7 }]; #IO_L6N_T0_VREF_34 Sch=ck_io[7]
#set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports LCD_SDA]
#set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports LCD_SCL]
##set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { ck_io10 }]; #IO_L11N_T1_SRCC_34 Sch=ck_io[10]
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports waveform_gen]
#set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports lowpass_in]
#set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports lowpass_o]

## ChipKit Inner Digital Header
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports UART_RX]; #[26]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports UART_TX]; #[27]
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { PS2_Clk }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=ck_io[28]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { PS2_Data }]; #IO_L10P_T1_34 Sch=ck_io[29]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { R_CLK }]; #IO_L9P_T1_DQS_34 Sch=ck_io[30]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { R }]; #IO_L9N_T1_DQS_34 Sch=ck_io[31]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { L_CLK }]; #IO_L20P_T3_34 Sch=ck_io[32]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { L }]; #IO_L20N_T3_34 Sch=ck_io[33]
...
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { LCD_SDA }]; #IO_L24P_T3_34 Sch=ck_sda
...
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[0]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[1]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[2]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[3]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[4]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[5]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[6]}]
set_property MARK_DEBUG true [get_nets {inst_uart/rx_reg[7]}]
set_property MARK_DEBUG true [get_nets iEn]
set_property MARK_DEBUG false [get_nets {GAME_DATA[36]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[53]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[60]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[72]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[76]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[108]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[37]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[100]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[117]}]
set_property MARK_DEBUG false [get_nets {GAME_DATA[124]}]

set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[64]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[93]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[105]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[80]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[98]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[67]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[125]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[45]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[106]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[121]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[69]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[113]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[48]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[83]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[114]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[37]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[72]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[90]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[102]}]
set_property MARK_DEBUG false [get_nets {insty_GAME_Logic/q[109]}]
